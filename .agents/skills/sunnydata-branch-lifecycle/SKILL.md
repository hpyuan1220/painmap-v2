...
**Step 3 — Ask user (only if no directory and no AGENTS.md preference):**
...
**Check each commit against `.Codex/rules/git-workflow.md`:**
...
Create PR following `.Codex/rules/git-workflow.md` PR quality standard:
...
**Always:**
- Directory priority: existing > AGENTS.md > ask
...
- `.Codex/rules/git-workflow.md` — commit and PR message format reference
